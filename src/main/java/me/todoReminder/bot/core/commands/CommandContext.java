...
public class CommandContext {
    ...
    private final UserSchema userData;


    public CommandContext(MessageReceivedEvent event, String commandName, String args, UserSchema userData, int listIndex, String prefix) {
        jda = event.getJDA();
        this.event = event;
