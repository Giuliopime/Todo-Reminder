...
public class Invite extends Command {
    ...
    public void run(CommandContext ctx) {
        ctx.sendMessage(EmbedReplies.infoEmbed(false).setTitle("Invite me!", "https://discord.com/oauth2/authorize?client_id=763067629023526954&scope=bot&permissions=355392"));
    }
}
